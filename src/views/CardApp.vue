<template>
  <div class="wallet-container">
    ...
    <div class="wallet-header">
      <span class="header-title">{{ isEditMode ? '빠른 실행 편집' : '삼성페이 스타일 지갑' }}</span>
    ...
    <!-- 2. 삼성페이식 순서변경 모드 (세로 Stacked 롱프레스 드래그) -->
...
.notification-dot { position: absolute; top: 8px; right: 8px; width: 5px; height: 5px; border-radius: 50%; background: #f04a43; }
